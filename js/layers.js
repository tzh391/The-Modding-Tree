...
addLayer("e", {
        ...
        upgrades: {
                ...
                43: {
                        ...
                        description(){
                                let a = "F 11 gives free E 33 levels, double Finch gain, and decrease base Finch gain by .1%"
                                return a
                        },
                ...
                45: {
                        ...
                        description(){
                                let a = "F 13 gives free F 12 levels, Tiers past 1000 add .0005 to the Finch gain exponent, and divide Finch gain by 5e163"
                                return a
                        },
...
addLayer("f", {
        ...
        upgrades: {
                ...
                24: {
                        ...
                        description(){
                                let a = "Tier buyables increase the same row buyables bases by 5% and increase F 11 linear base by .063"
                                return a
                        },
                        onPurchase(){
                                player.E.buyables[31] = decimalZero
        ...
        milestones: {
                ...
                4: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: Autobuy Tiers, gain " + makeBlue("1e1000") + "x Duck, and Filter base cost is 1. Per reset keep an Emerald and Eagle upgrade and divide E 33 base cost by 10^Finches."
                ...
                6: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: Eagle Milestone 91 and Emerald Milestone 3 no longer affect effective Tiers. Multiply Tired Tier base by " + makeBlue("1.49") + "."
                                return "Reward: Eagle Milestone 91 and Emerald Milestone 3 no longer affect effective Tiers. Multiply Tired Tier base by 1.5/1.01 (~1.49)."
                        },
                }, // hasMilestone("f", 6)
                7: {
                        requirementDescription(){
                ...
                11: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: You always have at least 20 seconds of Finch production, subtract 1 from the Passive Gain goal" + makeBlue(" and autobuy Finch buyables") + "."
                ...
                14: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: Subtract 1 from Sieve's linear cost base and F 13 always divides F 12 base cost " + makeBlue(" double the Finch autobuyer speed") + "."
                ...
                18: {
                        ...
                        effectDescription(){
                                return "Reward: Divide F 21 linear cost base by 1e100 and F 22 linear cost base by 4e34 but increase its base cost by 4e14,141. At 2e91,313 Finches divide F 22 linear cost base by 5e144 and Better Everything base by 2."
                        },
                }, // hasMilestone("f", 18)
                19: {
                        requirementDescription(){
                                return "9.1e91,919 Finches"
                        },
                        done(){
                        ...
                        effectDescription(){
                                return "Reward: F 21 gives free F 13 levels and triple Finch's effect exponent but divide Finch gain by 2e543. At 1309 Tiers and 1e92,322 Finches, divide F 22 linear cost base by 7e77."
                        },
                }, // hasMilestone("f", 19)
                20: {
                        requirementDescription(){
                                return "1e95,689 Finches"
                        },
                        done(){
                ...
                21: {
                        ...
                        effectDescription(){
                                return "Reward: The Finch autobuyer is always active, F 21 base becomes [levels]/100 but divide its linear cost base by 1e5. At 1e96,605 Finches double Agile effect but multiply F 12 base cost by 1e600."
                        },
                }, // hasMilestone("f", 21)
                22: {
                        requirementDescription(){
                ...
                25: {
                        ...
                        effectDescription(){
                                return "Reward: Divide F 31 linear cost base by 1e188 and Sieve levels subtract from Dlareme quadratic base (max 9000). At 1e7390 Emeralds, add .0001 to the Dlareme base per Better Everything past 90 (reduce to 30/0 at 1e349,800/1e358,306 Finches)."
                        },
                }, // hasMilestone("f", 25)
                26: {
                        requirementDescription(){
                                return "1e352,550 Finches"
                        },
                        done(){
                ...
                27: {
                        ...
                        effectDescription(){
                                return "Reward: Divide Grade Milestone 6 per by 10. Reapply this at 1e602,907, 1e623,648, 1e630,327, 1e833,329, 3e837,524, 1e851,865, 1e857,997, 1e864,355, 1e890,441, 1e901,228, 1e986,934 and 1e1,145,677 Finches."
                        },
                }, // hasMilestone("f", 27)
        },
        challenges: {
                ...
                21: {
                        ...
                        fullDisplay(){
                                ...
                                a += " and keep all but " + formatWhole(hasMilestone("G", 2) ? 100 - Math.max(0, player.f.challenges[21]-1)**2 : 100 - 2 * player.f.challenges[21]) + " Tiers (outside of challenges)"
...
addLayer("E", {
        ...
        upgrades: {
                ...
                11: {
                        ...
                        description(){
                                let a = "The first ten upgrades unlock a buyable and increases base Eagle gain by 1%"
                                return a
                        },
                        cost: new Decimal(10),
                        unlocked(){
                ...
                24: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>IX Emerald"
                        },
                        description(){
                                let a = "Dlareme levels multiply F 1X base costs by 1e60 and you can buy all Finch buyables at once"
                                return a
                        },
                        cost(){
                ...
                25: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>X Emerald"
                        },
                        description(){
                                let a = "At 1e7014, 1e7102, 2e7142, and 1e7161 Emeralds, divide F 31 linear cost base by 1e480"
                                return a
                        },
                        cost(){
                ...
                32: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>XII Emerald"
                        },
                        description(){
                                return "Gain 10x Emeralds post reduction and the first 500 Better Everything levels subtract .001 from the Rank III base"
                        },
                        cost(){
                ...
                33: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>XIII Emerald"
                        },
                        description(){
                                return "Remove the +x from Rank I's cost formula"
                        },
                        cost(){
        ...
        milestones: {
                ...
                8: {
                        ...
                        effectDescription(){
                                return "Reward: Tiers multiply Duck bulk amount and F 11 levels subtract .0001 to the F 12 base and subtract 1 from the linear cost base (max 77777)."
                        },
                }, // hasMilestone("E", 8)
                9: {
                        requirementDescription(){
                ...
                11: {
                        ...
                        effectDescription(){
                                return "Reward: Tiers past 1000 subtract .1 from the Sieve linear cost base (fifth after 640, halve after 1150, halve after 1400, fifth after 1675, fifth at 2300) but F 13 linear cost base is 15e20."
                        },
                }, // hasMilestone("E", 11)
                12: {
                        requirementDescription(){
                ...
                13: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: Rank II exponent is ^2, Tier buyables cost is x<sup>2</sup>, increase Finch buyable base costs by " + makeBlue("1e80") + ", and reduce F 21 linear cost base to 1.8e308."
                                return "Reward: Rank II exponent is ^2, Tier buyables cost is x<sup>2</sup>, increase Finch buyable base costs by 1e88, and reduce F 21 linear cost base to 1.8e308."
                        },
                }, // hasMilestone("E", 13)
                14: {
                        requirementDescription(){
                        ...
                        effectDescription(){
                                return "Reward: Tiers past 1063 (max 100) multiply Sifter's base by Tiers/1000 but increase F 12 base cost by 1e414. At 1e3233 Emeralds, the first 340 F 21 levels halve its linear cost base (half as effective after 175, 200, and 300)."
                        },
                }, // hasMilestone("E", 14)
                15: {
                        requirementDescription(){
                ...
                16: {
                        ...
                        effectDescription(){
                                if (player.f.points.gte("1e93687")) return "Reward: At <b>1e92,933</b> / <b>1e93,279</b> / <b>1e93,687</b> / 1e94,153 Finches, decrease F 22 linear cost base by <b>2.3e56</b> / <b>4e54</b> / <b>6.6e43</b> / 1.2e23."
                                if (player.f.points.gte("1e93279")) return "Reward: At <b>1e92,933</b> / <b>1e93,279</b> / 1e93,687 Finches, decrease F 22 linear cost base by <b>2.3e56</b> / <b>4e54</b> / 6.6e43."
                                if (player.f.points.gte("1e92933")) return "Reward: At <b>1e92,933</b> / 1e93,279 Finches, decrease F 22 linear cost base by <b>2.3e56</b> / 4e54."
                ...
                20: {
                        ...
                        effectDescription(){
                                let r = "Reward: Multiply F 1X base costs by 1e2850 and square root them and F 22 gives free F 21 levels."
                                if (player.E.points.gte("1e5600")) r += " At 1e5653 / NEXT1 Emeralds divide F 22 base by 2 / NEXT2. At 5e164,970 and 1e174,460 Finches triple Faster Sifter base."
                ...
                21: {
                        ...
                        effectDescription(){
                                return "Reward: Multiply Better Everything linear cost base by 7. At 1e191,769 Finches add 2 to the Finch gain exponent but multiply F 12 base cost by 1e2480." 
                        },
                }, // hasMilestone("E", 21)
                22: {
                        requirementDescription(){
                                return "1e13,146 Emeralds"
                        },
                        done(){
                        ...
                        effectDescription(){
                                return "Reward: F 22 affects F 3X buyables per Grade but multiply F 21 and F 22 base costs by 1e15,001 and Finch Milestone 7 starts 400 later." 
                        },
                }, // hasMilestone("E", 22)
        },
        buyables: getLayerGeneralizedBuyableData("E", [
...
addLayer("T", {
        ...
        upgrades: {
                ...
                31: {
                        ...
                        description(){
                                let a = "F 23 gives free F 21 levels but divide Finch gain by 1e200 and at 1532 Tiers E 31 gives free E 23 levels"
                                return a
                        },
                ...
                35: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>XV Tier"
                        },
                        description(){
                                let a = "Tenth Dlareme quadratic cost base and at 1e7289 Emeralds raise Faster Sifter base ^1.234"
                                return a
                        },
                ...
                41: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>XVI Tier"
                        },
                        description(){
                                let a = "Third F 22 linear cost base. Reapply this at 1e9096 Emeralds. Reapply this upgrade 3x at 1e9097 Emeralds."
                                return a
                        },
        ...
        milestones: {
                ...
                7: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked) return "Reward: Tiers subtract from Faster Sifter linear cost base (max 92 times) and quarter E 32 linear cost base." + makeBlue(" Autobuy Tiers and bulk twice as many Emerald buyales.")
                ...
                17: {
                        ...
                        effectDescription(){
                                if (player.G.unlocked )return "Reward: Tiers subtract .0001 from the Better Everything quadratic cost base and ones past 785 divide base cost by 1e15" + makeBlue(" and double Finch autobuyer bulk") + "."
                ...
                19: {
                        ...
                        effectDescription(){
                                return "Reward: F 13 gives free F 11 levels, but divide Finch gain by 1e8000 and multiply F 12 base cost by 1e1111. Tiers past 1000 decrease Lazy Tiers quadratic base by .0001 (until 1000 tiers, every other after 832)."
                        },
                }, // hasMilestone("T", 19)
                20: {
                        requirementDescription(){
                        ...
                        effectDescription(){
                                return "Reward: Each F 13 past 4150 divides its linear cost base by 1.001 (every other/fourth/eigth after 13594/17700/34000 times) and triple Finch effect exponent (and again at 1e92,536 Finches). Divide F 22 linear cost base by 2.5e5."
                        },
                }, // hasMilestone("T", 20)
        },
        buyables: {
                ...
                11: {
                        ...
                        display(){
                                ...
                                if (hasUpgrade("E", 24)) costForm += br + "Note: Does not affect Dlamere" + br
                ...
                12: {
                        ...
                        display(){
                                if (!player.shiftAlias) {
                                        ...
                                        if (hasUpgrade("f", 25)) eff = eff.replace("F 11 base", "F 11 and F 13 bases")
                ...
                41: {
                        ...
                        display(){
                                ...
                                let costForm = "<b><h2>Cost formula</h2>:<br> x<sup>2</sup> + x + 899END</b>" + br
                ...
                43: {
                        ...
                        display(){
                                if (!player.shiftAlias) {
                                        let amt = "<b><h2>Amount</h2>: " + getBuyableAmountDisplay("T", 43) + "</b><br>"
                                        let cost = "<b><h2>Requires</h2>: " + formatWhole(tmp.T.buyables[43].requires) + " F 31</b><br>"
                                ...
                                let costForm = "<b><h2>Cost formula</h2>:<br> " + str +  "<sup>x</sup></b>" + br
                                return br + costForm
                        },
                        canAfford(){
...
addLayer("G", {
        name: "Grade", // This is optional, only used in a few places, If absent it just uses the layer id.
        ...
        roundUpCost: true,
        baseAmount() {return player.T.points.floor()}, // Get the current amount of baseResource
        type: "static", // normal: cost to gain currency depends on amount gained. static: cost depends on how much you already have
        base(){
                let ret = Decimal.pow(3, .01)
        ...
        effectDescription(){
                return "subtracting " + formatWhole(tmp.G.effect) + " effective Tiers"
        },
        //canReset(){
        //        return player.E.points.gte(tmp.T.getNextAt)
        //},
        upgrades: {
                ...
                11: {
                        title(){
                                return "<bdi style='color: #" + getUndulatingColor() + "'>Grade I"
                        },
                        description(){
                                return "idk"
                        },
        ...
        milestones: {
                1: {
                        ...
                        effectDescription(){
                                return "Reward: Keep a Finch reset and milestone per Grade, and Tiers past 0 / 1 add to the Duck / Eagle gain exponent. Multiply by (Grades + 1) and square the bulk of previous autobuyers, double their speed, and they always buy all buyables at once."
                        },
                }, // hasMilestone("G", 1)
                2: {
                        requirementDescription(){
                        ...
                        effectDescription(){
                                return "Reward: Keep Capybara challenges and autobuy Emerald buyables. Only Finch's keeping Tiers works in challenges and is better (does not improve you past normal progression). E 22 gives free E 21 levels instead of free E 11 levels."
                        },
                }, // hasMilestone("G", 2)
                3: {
                        requirementDescription(){
                        ...
                        effectDescription(){
                                return "Reward: Keep the first three Finch challenges and Finch milestone 7 start two tiers earlier per Grade. Remove F 1X base costs."
                        },
                }, // hasMilestone("G", 3)
                4: {
                        requirementDescription(){
