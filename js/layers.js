        ...
        milestones: {
                ...
                7: {
                        ...
                        start(){
                                ...
                                if (hasMilestone("G", 3))r -= player.G.points.times(2).min(120).floor().toNumber()
                                return r
                        },
                        effectDescription(){
                                if (hasUpgrade("e", 32)) {
        ...
        buyables: {
                ...
                43: {
                        ...
                        display(){
                                ...
                                let costForm = "<b><h2>Cost formula</h2>:<br> " + formatWhole(tmp.T.buyables[43].base) +  "<sup>x</sup></b>" + br
                                return br + costForm
                        },
                        canAfford(){
