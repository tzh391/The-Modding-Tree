...
var MAIN_BUYABLE_DATA = {
        ...
        E13: {
                ...
                bases(){
                        ...
                        if (hasMilestone("T", 19)) {
                                b2 = b2.sub(player.T.points.sub(1000).max(0).div(10000).min(.09))
                                //b2 = b2.sub(player.T.points.sub(1700).max(0).div(2).floor().div(10000).min(.02))
                        }
        ...
        E31: {
                ...
                bases(){
                        ...
                        if (hasMilestone("E", 11)) {
                                ...
                                b1 = b1.sub(player.T.points.sub(1640).max(0).div(50).min(640))
                        }
        ...
        f12: {
                name: "F 12",
                func: "exp",
                effects: "Finch and base Eagle gain<sup>*</sup>",
                base: {
                        initial: new Decimal(2),
                        1: {
                                active(){
        ...
        f13: {
                ...
                bases(){
                        ...
                        if (getBuyableAmount("f", 13).gte(3060)) b1 = new Decimal(2.44e21)
                        if (player.f.challenges[31] >= 1)        b1 = new Decimal(2.74e21)
                        if (getBuyableAmount("f", 13).gte(3200)) b1 = new Decimal(2.82e21)
                        ...
                        if (getBuyableAmount("f", 13).gte(3350)) b1 = new Decimal(4.5e21)
        ...
        f22: {
                name: "F 22",
                func: "exp",
                effects: "Speedy base (max *2) and divide F buyable linear cost bases",
                base: {
                ...
                bases(){
                        ...
                        if (hasMilestone("E", 19))      b1 = b1.div(Decimal.pow(2, player.f.buyables[23].max(56).sub(70).min(100)))
        ...
        f23: {
                name: "F 23",
                func: "lin",
                effects: "Finch gain exponent and Filter base",
                base: {
                        initial: new Decimal(.1),
                },
                bases(){
                        ...
                        if (hasMilestone("E", 19))      b1 = b1.div(Decimal.pow(2, player.f.buyables[22].max(69).sub(70).min(100)))
